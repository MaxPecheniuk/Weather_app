...
export class CurrentWeatherProvider extends BaseProvider {
  fetchCurrentWeather(id: string): Promise<Array<CurrentWeatherTypes>> {
    return this.get<Array<CurrentWeatherTypes>>(`group?id=${id}&appid=${apiConfigs.token}&units=metric`);
  }
}
