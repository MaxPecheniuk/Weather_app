...
- [Running Tests](#running-tests)
  ...
  - [Initializing DetailedWeatherItem Environment](#initializing-test-environment)
...
This test mounts a component and makes sure that it didn’t throw during rendering. Tests like this provide a lot value with very little effort so they are great as a starting point, and this is the test you will find in `src/App.DetailedWeatherItem.tsx`.
...
### Initializing DetailedWeatherItem Environment
